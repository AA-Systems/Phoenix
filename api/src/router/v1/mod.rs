...
use crate::{
    app_state::AppState,
    router::v1::{
        assets::assets_router, auth::auth_router, balances::balances_router, health::health_router,
        markets::markets_router, orders::orders_router,
    },
};
...
pub fn v1_router(app_state: AppState) -> Router<AppState> {
    Router::new()
        ...
        .nest("/assets", assets_router(app_state.clone()))
