...
const principles = [
  {
    ...
    copy: "A deliberate spot interface that puts pairs, balances, and execution ahead of promotion.",
    imagePath: "/images/features/market-workspace.webp",
    detail: "Pairs · price · movement",
  },
  {
    icon: Boxes,
    number: "02",
    ...
    imagePath: "/images/features/balance-inventory.webp",
    detail: "Available · locked · total",
  },
  {
    icon: KeyRound,
    number: "03",
    title: "Own the session",
    copy: "Short-lived access tokens and rotating refresh sessions keep account access contained.",
    imagePath: "/images/features/protected-sessions.webp",
    detail: "Access · refresh · revoke",
  },
];
      ...
      <main>
        ...
        >
          <div className="grid gap-10 pb-20 lg:grid-cols-[0.7fr_1.3fr]">
            <div>
              ...
              <p className="mt-3 max-w-xs text-sm leading-6 text-[#716878]">
                The exchange is designed as one connected system, not a
          ...
          <div>
            {principles.map(
              (
                { icon: Icon, number, title, copy, imagePath, detail },
                index,
              ) => (
                <article
                ...
                >
                  <div
                    className={`relative min-h-[440px] overflow-hidden rounded-[18px] border border-[#3b3243] bg-[#15111a] transition-transform duration-500 group-hover:-translate-y-1 lg:min-h-[520px] ${
                  ...
                  <div className="px-2 sm:px-8 lg:px-10">
                    ...
                    <div className="mt-10 border-t border-[#302839] pt-5">
